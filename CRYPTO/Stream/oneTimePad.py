...
true_secret = open('E:\\CTF\\CTFQD\\Crypto\\efed073d048f40119b1e7ec2577910ee\\flag.txt').read()[:32]
...
ctxt1 = hex(str2num(true_secret) ^ next(generator))[2:-1]
ctxt2 = hex(str2num(fake_secret1) ^ next(generator))[2:-1]
ctxt3 = hex(str2num(fake_secret2) ^ next(generator))[2:-1]
print(ctxt1)
print(len(bin(int(ctxt1,16))))
print(ctxt2)
print(len(bin(int(ctxt2,16))))
print(ctxt3)
print(len(bin(int(ctxt3,16))))
